...
def mostrar_menu():
    while True:
        ...
        if motor == 'R':
            print(Fore.YELLOW + "Rutina definida")
            # Agrega los valores determinados de la rutina aquí
            
            comandos_acumulados.append(b'PD,A,1000\n')  # Ejemplo de comando para el motor A
            ...
            comandos_acumulados.append(b'GC\n')
            ser.write(b'MI\n')         # Comando para ejecutar los movimientos 
        else:
            try:
